...
public class GreetingPagesTest {
    ...
    public void loadHomePage() throws Exception {
        ...
        assertThat(out.toString().contains("<title>Home Page</title>"), is(true));
    }
    ...
    public void goToPageOnce() throws Exception {
        ...
        assertThat(out.toString().contains("<h1>Welcome to Page 1</h1>"), is(true));
    }
    ...
    public void goToPageTwice() throws Exception {
        ...
        assertThat(out.toString().contains("<h1>You already were here</h1>"), is(true));
    }
    ...
    public void goToDifferentPages() throws Exception {
        ...
        assertThat(out.toString().contains("<h1>Welcome to Page 3</h1>"), is(true));
